...
number1 = int(input(" Pershe chyslo typu int: "))
number2 = int(input(" Druhe chyslo typu int: "))
number3 = int(input(" Trete chyslo typu int: "))
print(" Suma chisel =", number1 + number2 + number3)
input()